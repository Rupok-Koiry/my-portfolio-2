...
router.route('/').get(experience_controller_1.getAllExperiences).post((0, auth_1.default)('admin'), experience_controller_1.createExperience);
router
    .route('/:id')
    .get(experience_controller_1.getExperience)
